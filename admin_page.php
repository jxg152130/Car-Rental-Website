...
<head>
    ...
    <title>SMAB - Your Car Rental Solution</title>
...
<body id="page-top" class="index">
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <button type="button" class="page-scroll btn btn-xl" id="showsignup" ><a href="#services" style="color:white">Add</a></button>&nbsp;
				<button type="button" class="page-scroll btn btn-xl" id="showsignin" ><a href="#services1" style="color:white">Modify</a></button>&nbsp;
				<button type="button" class="page-scroll btn btn-xl" id="showcheckin" ><a href="#services2" style="color:white">Car CheckIn</a></button>
            </div>
        </div>
    ...
    <section id="services" class="signup">
      ...
      <tr><td>Car Company:&nbsp &nbsp &nbsp </td><td> <select name="company_1" id="company_1" onChange="changeSecond_1(this.value)" > 
        ...
        <div class="form-group">
        <input type="text" class="form-control" placeholder="Company Name[other]" name="company_name" id="company_name" /> 
        </div>
        
        <div class="form-group">
        <input type="text" class="form-control" placeholder="type[other]" name="type_2" id="car_type" />
        <span id="check-e" style="color:red"></span>
        </div>
        
        <div class="form-group">
        <input type="text" class="form-control" placeholder="model[other]" name="model_2" id="car_model" /><span id="emptyp" style="color:red"></span>
        </div>
	  ...
	  <div id="ack"></div>
	   ...
	   <section id="services2" class="checkin">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">checkIn the car</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Nurturing Future!</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
